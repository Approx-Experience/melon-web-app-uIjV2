...
export default function Banner() {
  return (
    <div className="banner desktop-banner-bg d-flex align-items-center justify-content-around p-5">
      <div className="d-flex flex-column align-items-start">
        ...
        <a href="/browse"><Button variant="primary" className="desktop-button">
          SHOP NOW
        </Button>
        </a>
      </div>
