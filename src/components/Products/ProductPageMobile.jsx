    ...
    <div className="product-page-wrapper-mobile">
      ...
      <div className="product-details-container-mobile">
        ...
        <p className="product-description-mobile">
          Product description. You can do a lot of cool stuff while wearing this
          piece. People will like you more and you'll be more confident. Stop
          limiting yourself and buy this thing. You need it and you want it.
        </p>
